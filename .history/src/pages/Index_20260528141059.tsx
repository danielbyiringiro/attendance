...
type TATab = "attendance" | "analytics";
...
const Index = () => {
  ...
  if (isTA) {
    const title = taTab === "analytics" ? "Attendance Analytics" : "TA Dashboard";
                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      tooltip="Attendance"
                    >
                      <button type="button" onClick={() => setTaTab("attendance")}>
                        <CalendarDays />
                  ...
                  <SidebarMenuItem>
                    ...
                    >
                      <button type="button" onClick={() => setTaTab("analytics")}>
                        <BarChart3 />
