...
/**
 * Whether this screen chimes for check-ins, remembered on this device.
 *
 ...
 * On by default — the chime is what was asked for — and muted with one tap.
 *
 ...
 *
 * Switching it on plays the chime once. It confirms the speakers are up before
 * a room of check-ins depends on them, and it is the only way to hear what it
 * sounds like without somebody checking in.
 */
